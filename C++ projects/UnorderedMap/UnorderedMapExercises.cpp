...
StringIntMap makeWordCounts(const StringVec& words) {
  StringIntMap wordcount_map;
    ...
    for (std::string i : words){
        ...
        //These conditions work because c++ will check both conditions consequtively.
        //It will not choose.
        //The first condition creates the key.
        // The second condition sets up the recursive valueing system of the key.
        
        
        
        // First says: "exists?"
        //"no?"
        //"lets bring you into existence!
        //"But you will have an inacurate count."
        //"Trust the next condition to provide accurate count!"
        //"And know that the second condition will be met and come to pass because of me since I made you real !!!"
        
        
        // Second Says: "exists?"
        //"YES?!?!"
        //"Lets tweak your count!"
        //"Now you're PERFECT!"
        ...
        if(    wordcount_map.count(i)      ){
            wordcount_map[i] = wordcount_map[i] + 1;
        }
